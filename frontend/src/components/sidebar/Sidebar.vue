<template>
  <aside class="bg-white text-black w-64" :class="{ 'w-12': isCollapsed }" style="transition: width 0.5s ease">
    <div class="flex flex-col">
      <!-- Collapse Button -->
      <div @click="sidebarShow" class="flex items-center justify-end px-3 h-12 text-gray-500 hover:text-black">
